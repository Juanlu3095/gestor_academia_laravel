...
Route::middleware('auth')->group(function () {
    ...
    /* Profesores */
    Route::get('/profesores', [TeacherController::class, 'index'])->name('profesores.index');
    ...
    Route::get('/incidencias/{id}', [IncidenceController::class, 'details'])->name('incidencias.details');

    ...
    <section class="desktop">
        ...
        <nav class="menu">
            <ul class="menu-list">
                ...
                <li><a class="menu-item" href="{{ route('incidencias.index') }}">Incidencias</a></li>
            ...
            <div class="offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar" aria-labelledby="offcanvasNavbarLabel">
                ...
                <div class="offcanvas-body">
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link menu-item" aria-current="page" href="{{ route('welcome') }}">Inicio</a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a class="nav-link menu-item" href="{{ route('incidencias.index') }}">Incidencias</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-item" href="{{ route('alumnos.index') }}">Alumnos</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-item" href="{{ route('profesores.index') }}">Profesores</a>
                        </li>

                        <li class="nav-item">
                            <a class="nav-link menu-item" href="{{ route('perfil') }}">Perfil</a>
                        </li>
                    </ul>
                </div>
            </div>
